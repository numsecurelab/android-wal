...
import io.space.bitcoincore.models.BalanceInfo
import io.space.bitcoincore.models.BlockInfo
...
import io.space.bitcoincore.utils.MerkleBranch
import io.space.bitcoincore.utils.PaymentAddressParser
import io.space.dashkit.core.DashTransactionInfoConverter
import io.space.dashkit.core.SingleSha256Hasher
import io.space.dashkit.instantsend.*
import io.space.dashkit.instantsend.instantsendlock.InstantSendLockHandler
import io.space.dashkit.instantsend.instantsendlock.InstantSendLockManager
import io.space.dashkit.instantsend.transactionlockvote.TransactionLockVoteHandler
import io.space.dashkit.instantsend.transactionlockvote.TransactionLockVoteManager
import io.space.dashkit.managers.*
import io.space.dashkit.masternodelist.*
import io.space.dashkit.messages.*
import io.space.dashkit.models.CoinbaseTransactionSerializer
import io.space.dashkit.models.DashTransactionInfo
import io.space.dashkit.models.InstantTransactionState
import io.space.dashkit.storage.DashKitDatabase
import io.space.dashkit.storage.DashStorage
import io.space.dashkit.tasks.PeerTaskFactory
import io.space.dashkit.validators.DarkGravityWaveTestnetValidator
import io.space.dashkit.validators.DarkGravityWaveValidator
...
class DashKit : AbstractKit, IInstantTransactionDelegate, BitcoinCore.Listener {
    ...
    constructor(
        ...
        network = when (networkType) {
            NetworkType.MainNet -> {
                initialSyncUrl = "https://dash.space.xyz/apg"
                MainNetDash()
            }
            NetworkType.TestNet -> {
                initialSyncUrl = "http://dash-testnet.space.xyz/apg"
                TestNetDash()
            }
        }
